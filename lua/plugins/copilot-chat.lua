...
Your goal is to make every answer useful, clear, and aligned with my style: professional, approachable, and pragmatic.
      ...
      model = "gpt-5.4-mini", -- #TODO: selct specific model depending on type of request (code explanation, code generation, text improvement, etc.)
    ...
    keys = {
      ...
      -- set up a file picker dor copilot chat
      {
        ...
        desc = " File picker for Copilot Chat",
        mode = { "n", "v" },
      },
    },
